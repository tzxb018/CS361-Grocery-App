...
SELECT ItemId, Item.Name, Checkoff, Item.Date, Item.GroceryListId, GroceryList.Name
...
SELECT ItemId, Item.Name, Checkoff, Item.Date, Item.GroceryListId, GroceryList.Name, Account.AccountId, Account.Username, Account.EncryptedPassword
